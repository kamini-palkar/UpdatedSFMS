...
class InfoController extends Controller
{
    ...
    public function viewAllOrgData()
    {
        ...
        foreach ($uniqueCodes as $code) {
            ...
            $totalSize = FileUploadModel::where('organisation_id', $organisation->id)->sum('size_in_bytes');
            ...
            $size = round($totalSize / pow(1024, $power), 2);
    ...
    public function viewOwnOrgData(Request $request){
        ...
        $totalSize = FileUploadModel::where('organisation_id', $id)->sum('size_in_bytes');
