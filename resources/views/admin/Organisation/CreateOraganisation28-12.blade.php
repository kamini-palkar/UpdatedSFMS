                    ...
                    <div class="col-xl-12">
                        <div class="card card-flush h-lg-100" id="kt_contacts_main">
                            ...
                            <div class="card-body pt-5">
                                <form method="POST" id="form" action="{{ route('create-organisation') }}">
                                    @csrf
                                        ...
                                        <div class="col">
                                            <div class="fv-row mb-2">
                                                <label class="fs-6 fw-bold form-label mt-3">
                                                    ...
                                                    <small style="color:red; margin-top:6px;padding-left:8px;">[ Note : You can add multiple emails at a Time ]</small>
                                                </label>
                                    ...
                                    <div style="float:right;">
                                        ...
                                        <a href="{{route('show-organisation')}}"  class="btn btn-outline-danger"  style="margin-right:10px;">Cancel</a> 
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        form.addEventListener('submit', function (event) {
            ...
            if (codeInput.value.trim() === '') {
                codeError.textContent = 'Organisation Code is required.';
                event.preventDefault();
            } else {
