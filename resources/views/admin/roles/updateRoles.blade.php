                    ...
                    <div class="col-xl-12">
                        <div class="card card-flush h-lg-100" id="kt_contacts_main">
                            ...
                            <div class="card-body pt-5">
                                <form method="POST" id="form"  action="{{ route('update-role',encrypt($edit->id)) }}">
                                    @csrf
                                        ...
                                        <div class="col" style="display:none">
                                            <div class="fv-row mb-2">
                                                ...
                                                <input type="text" name="guard_name" id="organisation_code"
                                                    ...
                                                    style="border: 1px solid black; padding: 13px;"
                                                    oninput="removeBorderStyle(this)" required readOnly>
                                    ...
                                    <div style="float:right;">
                                        ...
                                        <a href="{{route('show-role')}}" class="btn btn-outline-danger"  style="margin-right:10px;">Cancel</a> 
