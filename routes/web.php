...
Route::group(['middleware' => ['auth', 'web']], function () {
    ...
    Route::post('/show-datatable', [App\Http\Controllers\FileUploadController::class, 'showDataTable'])->name('show-datatable')->middleware('can:upload-files');
  ...
  //Project Module
  Route::get('/show-project', [App\Http\Controllers\ProjectController::class, 'showProject'])->name('show-project')->middleware('can:show-files');
